...
class Clothing extends Product {
  ...
  renderSizeChartLink() {
    // call method on perent class
    // super.renderSizeChartLink()
    return `
...
export function searchProduct (search) {
  ...
  return products.filter(product => {
    return product.name.toLowerCase() === search || product.keywords.includes(search)
  })
}
